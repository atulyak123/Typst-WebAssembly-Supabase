...
import { Plus, Search, Grid, List, Settings, HelpCircle, FileText, Users, Home, BarChart } from "lucide-react";
      ...
      <main className="flex-1 p-8 space-y-8">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-slate-500 text-sm mt-1">Welcome back, Atulya!</p>
          </div>
        ...
        {/* Create New Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4" onClick={handleNavigateToEditor}>
          <Card className="border-dashed border-2 hover:border-blue-400 hover:bg-blue-50/50 transition-all duration-200 cursor-pointer">
